...
$(document).ready(function(){
    $('#info-btn').click(function(){
        $(".resetPassword-panel").fadeOut(100, function(){
            $(".personal-info-panel").show();
        }); 
    });
    $('#reset-btn').click(function(){
        $(".personal-info-panel").fadeOut(100, function(){
    ...
    $('#update-btn').on("click", function(){
        ...
        if(userID){
            if(!username && !firstname && !lastname && !email && !phonenum ){
                ...
                displayresponse.html('Flmm change kitchose avn to update');
            }
            else{
                    ...
                    //if an error occur at the server side
                     if(checkresponseValidity == 'Invalid'){
                        $('#change-personal-info-response').html("*"+data);
                         ...
                         $('#change-personal-info-response').html("Update successful");
